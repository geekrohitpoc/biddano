...
public class OnboardingChatTests extends EnvironmentHelpers {
    ...
    public void verifyThatUserCanVisualizeTheDataOnDashboardForLastSevenDays() throws IOException {
        ...
        String ENDPOINT = UtilsHelpers.getProperties("Dashboard.properties", "GET_ONBOARDING_CHART_DATA");
        ...
        DashboardHelpers.validateDashboardOnboardingChartAPIContract(jsonPathEvaluator, 7);
    }
    ...
    public void verifyThatUserCanVisualizeTheDataOnDashboardForLastFifteenDays() throws IOException {
        ...
        JsonPath jsonPathEvaluator = response.jsonPath();
        DashboardHelpers.validateDashboardOnboardingChartAPIContract(jsonPathEvaluator, 15);
    }
    ...
    public void verifyThatUserCanVisualizeTheDataOnDashboardForLastThirtyDays() throws IOException {
        ...
        JsonPath jsonPathEvaluator = response.jsonPath();
        DashboardHelpers.validateDashboardOnboardingChartAPIContract(jsonPathEvaluator, 30);
    }
    ...
    public void verifyThatUserCanVisualizeTheDataOnDashboardForLastSixtyDays() throws IOException {
        ...
        JsonPath jsonPathEvaluator = response.jsonPath();
        DashboardHelpers.validateDashboardOnboardingChartAPIContract(jsonPathEvaluator, 60);
    }
    ...
    public void verifyThatUserCanVisualizeTheDataOnDashboardForCustomDays() throws IOException {
        ...
        JsonPath jsonPathEvaluator = response.jsonPath();
        DashboardHelpers.validateDashboardOnboardingChartAPIContract(jsonPathEvaluator, 4);
    }
